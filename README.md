...
# Download
You can download the mod [here](https://cdn.discordapp.com/attachments/309447635872382976/995362902552883201/WramDupeChecker_0.0.3.jar). The mod installs dependencies when the game is first launched.
...
## Cons
Due to us using ALL public and private API's to be more accurate, it can detect whether other players' items are duped.
